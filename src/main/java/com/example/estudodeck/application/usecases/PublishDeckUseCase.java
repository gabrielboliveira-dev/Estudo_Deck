...
@Service
public class PublishDeckUseCase {

    private final DeckRepository deckRepository;
    private final UserContext userContext;

    public PublishDeckUseCase(DeckRepository deckRepository, UserContext userContext) {
    ...
    public void execute(Input input) {
        ...
        Deck deck = deckRepository.findByIdAndUserId(input.deckId(), userId)
                .orElseThrow(() -> new ResourceNotFoundException("Deck not found or you don't own this deck"));
